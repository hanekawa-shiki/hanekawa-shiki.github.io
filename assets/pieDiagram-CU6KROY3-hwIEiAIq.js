import{t as e}from"./chunk-AQ6EADP3-Dtd8tM9Q.js";import{y as t}from"./chunk-KGYTTC2M-Bkhn8WKd.js";import{t as n}from"./chunk-JQRUD6KW-C_IOi1pe.js";import{W as r,c as i,p as a,q as o}from"./chunk-7W6UQGC5-DYO2qAFE.js";import{F as s,H as c,I as l,K as u,N as d,S as f,Y as p,Z as m,j as h,tt as g}from"./chunk-67TQ5CYL-B9gD1eUO.js";import{t as _}from"./chunk-LRIF4GLE-BvqASQcx.js";import"./chunk-KNLZD3CH-DeL6-SKs.js";import{a as v,p as y}from"./chunk-QA3QBVWF-CtDTmUML.js";var b=h.pie,x={sections:new Map,showData:!1,config:b},S=x.sections,C=x.showData,w=structuredClone(b),T={getConfig:e(()=>structuredClone(w),`getConfig`),clear:e(()=>{S=new Map,C=x.showData,p()},`clear`),setDiagramTitle:s,getDiagramTitle:u,setAccTitle:d,getAccTitle:g,setAccDescription:c,getAccDescription:f,addSection:e(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);S.has(e)||(S.set(e,t),o.debug(`added new section: ${e}, with value: ${t}`))},`addSection`),getSections:e(()=>S,`getSections`),setShowData:e(e=>{C=e},`setShowData`),getShowData:e(()=>C,`getShowData`)},E=e((e,t)=>{n(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),D={parse:e(async e=>{let n=await t(`pie`,e);o.debug(n),E(n,T)},`parse`)},O=e(e=>`
  .pieCircle{
